//got a lot of this from here https://www.youtube.com/watch?v=bMPLlS8uuwU
...
window.EnableKeyboardCapture = (componentRef) => {
    ...
    document.onkeydown = function (event) {
        ...
        switch (event.keyCode) {
            ...
            case KeyCodes.TAB:
                ...
                break;
            case KeyCodes.UP_ARROW || KeyCodes.KEY_W:
                raiseKeyDownEvent(code);
                break;
            case KeyCodes.DOWN_ARROW || KeyCodes.KEY_S:
                raiseKeyDownEvent(code);
                break;
            case KeyCodes.LEFT_ARROW || KeyCodes.KEY_A:
                raiseKeyDownEvent(code);
                break;
            case KeyCodes.RIGHT_ARROW || KeyCode.KEY_D:
                raiseKeyDownEvent(code);
                break;
            case KeyCodes.SPACE:
                raiseKeyDownEvent(code);
    ...
    function raiseKeyDownEvent(keyCode) {
        ...
        componentRef.invokeMethodAsync('WindowKeyDown', keyCode, shiftPressed, ctrlPressed, altPressed);
